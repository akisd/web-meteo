...
$tex = "ΕΛΑΧΙΣΤΗ: ". min($temp_d) . "       ΜΕΣΗ: " . sprintf('%0.2f',array_sum($temp_d)/count($temp_d)) . "       ΜΕΓΙΣΤΗ: " . max($temp_d);


$min_t = (int)min($temp_d)-1;
$max_t = (int)max($temp_d)+1;
...
$graph->SetScale("textlin",$min_t,$max_t+1); 
